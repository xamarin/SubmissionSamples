...
void xamarin_create_classes () {
	...
	__xamarin_class_map [7].handle = objc_getClass ("NSFileManager");
	__xamarin_class_map [8].handle = objc_getClass ("NSValue");
	__xamarin_class_map [9].handle = objc_getClass ("NSNumber");
	__xamarin_class_map [10].handle = objc_getClass ("NSPredicate");
	...
	__xamarin_class_map [33].handle = objc_getClass ("UIAlertAction");
	__xamarin_class_map [34].handle = objc_getClass ("UIAlertController");
	__xamarin_class_map [35].handle = objc_getClass ("CKRecord");
	__xamarin_class_map [36].handle = objc_getClass ("CKRecordID");
	...
	__xamarin_class_map [43].handle = objc_getClass ("MKShape");
	__xamarin_class_map [44].handle = objc_getClass ("MKPointAnnotation");
	__xamarin_class_map [45].handle = objc_getClass ("MKAnnotationView");
	__xamarin_class_map [46].handle = objc_getClass ("MKUserLocation");
	__xamarin_class_map [47].handle = objc_getClass ("MKOverlayRenderer");
	__xamarin_class_map [48].handle = objc_getClass ("UITextPosition");
	__xamarin_class_map [49].handle = objc_getClass ("UITextRange");
	...
	__xamarin_class_map [54].handle = objc_getClass ("CKAsset");
	__xamarin_class_map [55].handle = objc_getClass ("CKOperation");
	__xamarin_class_map [56].handle = objc_getClass ("CKDatabaseOperation");
	__xamarin_class_map [57].handle = objc_getClass ("CKDiscoveredUserInfo");
	__xamarin_class_map [58].handle = objc_getClass ("CKQuery");
	__xamarin_class_map [59].handle = objc_getClass ("CKQueryOperation");
	__xamarin_class_map [60].handle = objc_getClass ("CKReference");
	__xamarin_class_map [61].handle = objc_getClass ("CKSubscription");
	__xamarin_class_map [62].handle = objc_getClass ("UIWindow");
	__xamarin_class_map [63].handle = objc_getClass ("CKNotificationInfo");
	__xamarin_class_map [64].handle = objc_getClass ("CKQueryCursor");
	__xamarin_class_map [65].handle = objc_getClass ("CKModifySubscriptionsOperation");
	__xamarin_class_map [66].handle = objc_getClass ("CLRegion");
	__xamarin_class_map [67].handle = objc_getClass ("CLBeaconRegion");
	__xamarin_class_map [68].handle = objc_getClass ("CLBeacon");
	__xamarin_class_map [69].handle = objc_getClass ("CLHeading");
	__xamarin_class_map [70].handle = objc_getClass ("CLVisit");
	__xamarin_class_map [71].handle = objc_getClass ("CLLocation");
	...
	__xamarin_class_map [76].handle = objc_getClass ("NSSortDescriptor");
	__xamarin_class_map [77].handle = objc_getClass ("NSNull");
